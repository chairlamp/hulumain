      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1">
          <div className="flex items-center mb-6">
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-full ${step === "delivery" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
            >
              {step === "delivery" ? "1" : <Check className="h-4 w-4" />}
            </div>
            <div className="h-px w-8 bg-border"></div>
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-full ${step === "payment" ? "bg-primary text-primary-foreground" : step === "review" ? "bg-muted text-muted-foreground" : "bg-muted text-muted-foreground"}`}
            >
              {step === "payment" ? "2" : step === "review" ? <Check className="h-4 w-4" /> : "2"}
            </div>
            <div className="h-px w-8 bg-border"></div>
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-full ${step === "review" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
            >
              3
            </div>
          </div>
